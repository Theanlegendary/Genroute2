    ...
    card.innerHTML = `
      <div style="display:flex; align-items:center; gap:12px;">
        ...
        <div style="display:flex; flex-direction:column; align-items:center; gap:8px; flex-shrink:0;">
          ...
          <button onclick="event.stopPropagation(); copyToClipboard(JSON.stringify({ mfe_autofill: true, province: '${escHtml(r.province || '')}', province_kh: '${escHtml(r.province_kh || '')}', district: '${escHtml(r.district || '')}', district_kh: '${escHtml(r.district_kh || '')}', store_code: '${escHtml(r.store_code || r.branch_id || '')}' }), this);" title="Copy Autofill Data" style="border:none; background:#f97316; color:white; width:36px; height:36px; border-radius:10px; cursor:pointer; display:flex; align-items:center; justify-content:center; box-shadow:0 2px 8px rgba(249,115,22,0.3); transition:all 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
